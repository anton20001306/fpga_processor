...
//               c:/Users/disan/OneDrive/Desktop/Projects/NEXYS_A7_100T/ALU_16_bit/ALU_16_bit/ALU_16_bit.gen/sources_1/ip/div_gen_0/div_gen_0_stub.v
// Design      : div_gen_0
...
(* CHECK_LICENSE_TYPE = "div_gen_0,div_gen_v5_1_24,{}" *) (* core_generation_info = "div_gen_0,div_gen_v5_1_24,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=div_gen,x_ipVersion=5.1,x_ipCoreRevision=24,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_XDEVICEFAMILY=artix7,C_HAS_ARESETN=0,C_HAS_ACLKEN=0,C_LATENCY=21,ALGORITHM_TYPE=1,DIVISOR_WIDTH=16,DIVIDEND_WIDTH=16,SIGNED_B=1,DIVCLK_SEL=1,FRACTIONAL_B=0,FRACTIONAL_WIDTH=16,C_HAS_DIV_BY_ZERO=0,C_THROTTLE_SCHEME=4,C_TLAST_RESOLUTION=0,C_HAS_S_AXIS_DIVISOR_TUSER=0,C_HAS_S_AXIS_DIVISOR_TLAST=0,C_S_AXIS_DIVISOR_TDATA_WIDTH=16,C_S_AXIS_DIVISOR_TUSER_WIDTH=1,C_HAS_S_AXIS_DIVIDEND_TUSER=0,C_HAS_S_AXIS_DIVIDEND_TLAST=0,C_S_AXIS_DIVIDEND_TDATA_WIDTH=16,C_S_AXIS_DIVIDEND_TUSER_WIDTH=1,C_M_AXIS_DOUT_TDATA_WIDTH=32,C_M_AXIS_DOUT_TUSER_WIDTH=1}" *) (* downgradeipidentifiedwarnings = "yes" *) 
...
/* synthesis syn_black_box black_box_pad_pin="s_axis_divisor_tvalid,s_axis_divisor_tready,s_axis_divisor_tdata[15:0],s_axis_dividend_tvalid,s_axis_dividend_tready,s_axis_dividend_tdata[15:0],m_axis_dout_tvalid,m_axis_dout_tdata[31:0]" */
